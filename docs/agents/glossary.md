...
|---|---|---|
| **ULB** | User-Level Budget | A spending cap that applies to a single user (or to a default "everyone without their own cap"). Two flavors in this app: *individual ULB* and *universal ULB*. |
