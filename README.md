...
- **Snapshot warnings** — if `localStorage` is full when we try to save a pre-batch snapshot, you're warned that rollback won't be available before the batch proceeds.
